            ...
            <div className="main-body-heading">
                <div className="main-opening-heading">
                    ...
                    <div className="opening-heading-text">
                        ...
                        <p>~ Bro. Ric Worstell | Baptized 9/28/1967 | Ordained 12/15/2004 | Graduated Bible College 05/03/2013 ~<br />
                            Mark 16:15 - 'And He said unto them, Go ye into all the world, and preach the gospel to every creature.'</p>
